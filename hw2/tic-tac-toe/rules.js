...
*/
function play() {
	var inTable= /["A1", "A2", "A3", "B1", "B2", "B3", "C1", "C2", "C3"]/g;
	var userInput=document.getElementById("move_text_id");
	var pos=document.getElementById(userInput.value.toString());
	var valid= (userInput.value.match(inTable) && pos.innerHTML != "O" && pos.innerHTML != "X");
	var turninfo=document.getElementById("turn_info");
	if (valid){
		if(turn==1){
			pos.innerHTML="X";
	...
	var winner=(a1+a2+a3=="OOO" || a1+a2+a3=="XXX" || b1+b2+b3=="OOO" || b1+b2+b3=="XXX" || c1+c2+c3=="OOO" || c1+c2+c3=="XXX" || a1+b1+c1=="OOO" || a1+b1+c1=="XXX" || a2+b2+c2=="OOO" || a2+b2+c2=="XXX" || a3+b3+c3=="OOO" || a3+b3+c3=="XXX" || a1+b2+c3=="OOO" || a1+b2+c3=="XXX" || c1+b2+a3=="OOO" || c1+b2+a3=="XXX");
	if(winner){
		toggle_move();
		if(turn==1){
			alert("Winner is X");
